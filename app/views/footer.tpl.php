        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach($typeList as $type): ?>
              <li> <a href="<?php echo $this->router->generate('catalog-type', array('id' => $type->id())) ?>" class="text-muted"><?= $type->name() ?></a></li>
            <?php endforeach; ?>
            </ul>
          </div>
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach($brandList as $brand): ?>
              <li> <a href="<?php echo $this->router->generate('catalog-brand', array('id' => $brand->id())) ?>" class="text-muted"><?= $brand->name() ?></a></li>
            <?php endforeach; ?>
