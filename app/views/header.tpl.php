      ...
      <div class="container-fluid">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a href="<?php echo $this->router->generate('catalog-categoriesList')?>" class="nav-link">Catégories</a>
            </li>
            <li class="nav-item">
              <a href="<?php echo $this->router->generate('catalog-typesList') ?>" class="nav-link">Types de produit</a>
            </li>
            <li class="nav-item">
              <a href="<?php echo $this->router->generate('catalog-brandsList') ?>" class="nav-link">Marques</a>
            </li>
            <li class="nav-item">
